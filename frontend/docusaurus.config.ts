...
const config: Config = {
  ...
  tagline: 'Bridging AI agents with real-world robotic systems',
  ...
  url: 'https://ai-humanoid-robots-hakathon.vercel.app',
  ...
  organizationName: 'AI-humanoid-robots-hakathon', // Usually your GitHub org/user name.
  projectName: 'AI-humanoid-robots-hakathon', // Usually your repo name.
